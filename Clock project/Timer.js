export default class Timer{
    constructor(root){
        ...
        this.el.control.addEventListener("click",() =>{
         ...
         this.el.reset.addEventListener("click",() =>{
            const inputMintues= prompt("Enter number of minutes you piece of sht:");

            if(inputMintues<60){
                this.stop();
                this.remainingSeconds = inputMintues*60;
    ...
    updateInterfaceControls(){
        if(this.interval ===null){
            this.el.control.innerHTML = `<span class="material-symbols-rounded">start</span>`;
            this.el.control.classList.add("timer--btn--start");
            this.el.control.classList.remove("timer--btn--reset");
        }else{
            this.el.control.innerHTML = `<span class="material-symbols-rounded">restart</span>`;
            this.el.control.classList.add("timer--btn--reset");
